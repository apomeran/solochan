...
<div id="changuita-publicada" class="modal hide fade" tabindex="-1">
    <div class="modal-header">
        <h3 style="color: #32B96E !important">Felicitaciones</h3>
    </div>
    <div class="modal-body">
        <p>&iexcl;Tu changuita fue publicada correctamente!</p>
    </div>
    <div class="modal-footer">
        <button class="btn btn-link" data-dismiss="modal">Cerrar</button>
    </div>
