        ...
        <div id="header">
            <div class="row">
                <div class="span6" style="margin-left:9%">
                    <div class="row">
                        <div class="span6">
                            <a href="#/inicio" rel="address:/" class="logo bw"><img width=43% src="img/logo2c.png" alt="SoloChanguitas" /></a>
                            <div class="slogan givemefont">
                                <div class="social" style="">
                                    Trabajos por los que and&aacute;s preguntando
                                    <a class="bw" href="http://www.facebook.com/solochanguitas" style="margin-left:3px;" target="_blank"><img width=6% src="img/social/fb.png" alt="facebook" /></a>
                                    <a class="bw" href="https://twitter.com/solochanguitas" target="_blank"><img  width=6% src="img/social/tw.png" alt="twitter" /></a>
                                    <a class="bw" href="#" target="_blank"><img width=6% src="img/social/g+.png" alt="google plus" /></a>
                                    <a class="bw" href="#" target="_blank"><img width=6% src="img/social/li.png" alt="linkedin" /></a>
                                </div>
                            </div>
