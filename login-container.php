...
<div id="login-container" class="givemeback givemefont">
    ...
    <div class="login ">
        ...
        <div>
            <div class="login-social"><button class="btn btn-link" id="login-fb-btn"><img width="70%" src="img/social/fb2.png" alt="Iniciar sesi&oacute;n con Facebook"/></button></div>
            <div class="login-social"><button class="btn btn-link" id="login-li-btn"><img width="70%" src="img/social/li2.png" alt="Iniciar sesi&oacute;n con LinkedIn"/></button></div>
        </div>
    </div>
    <hr>
