...
<div class="givemeback givemefont">
    
    <div class="login">
        <div style="font-size: 20px;">Conectate con tu red social favorita</div>
        <div id="fb-root">
		</div>
        <div class="login-social"><button class="btn btn-link" id="login-fb-btn"><img src="img/login-fb.jpg" alt="Iniciar sesi&oacute;n con Facebook"/></button></div>
        <div class="login-social"><button class="btn btn-link" id="login-li-btn"><img src="img/login-li.jpg" alt="Iniciar sesi&oacute;n con LinkedIn"/></button></div>

    </div>
	<hr>
    <div class="login login-not-social">
        <div style="font-size: 12px;">O inici&aacute; sesi&oacute;n con tu usuario</div>
        <form id="form-login" >
